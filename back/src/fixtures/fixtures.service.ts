...
export class FixturesService {
  ...
  async createTestDB() {
    ...
    const location1 = await this.locationRepository.create({
      ...
      coordinates: { lat: '42.8329614811942', lon: '74.60827231407167' },
      description: 'Coffee Shop',
      workingHours: '09:00 - 00:00',
      contacts: '+996 500 00 00 11',
      images: [
        '/fixtures/capito_1.png',
        '/fixtures/capito_2.jpq',
        '/fixtures/capito_2.jpq',
        '/fixtures/capito_3.jpq',
      ],
    ...
    const location2 = await this.locationRepository.create({
      ...
      coordinates: { lat: '42.87556705011888', lon: '74.59202349185945' },
      description: 'Coffee Shop',
    ...
    const location3 = await this.locationRepository.create({
      ...
      coordinates: { lat: '42.836962165223305', lon: '74.61430728321682' },
      description: 'Pub',
      workingHours: '12:00 - 02:00',
      contacts: '+996 707 22 00 11',
      images: ['/fixtures/berlin_1.png', '/fixtures/berlin_2.jpq'],
    ...
    const location4 = await this.locationRepository.create({
      ...
      coordinates: { lat: '42.81647609022022', lon: '74.62420463562013' },
      description: 'Pub',
      workingHours: '10:00 - 01:00',
      contacts: '+996 555 00 55 11',
      images: [
        '/fixtures/pinta_1.jpq',
        '/fixtures/pinta_2.jpq',
        '/fixtures/pinta_3.jpq',
      ],
      subCategory: subCategory2ToMainCategory1,
      user: user,
      isApproved: true,
    ...
    const location5 = await this.locationRepository.create({
      ...
      coordinates: { lat: '42.87468644984395', lon: '74.59076285362245' },
    ...
    const location6 = await this.locationRepository.create({
      ...
      coordinates: { lat: '42.82063522995512', lon: '74.61700558662416' },
      description: 'Hotel',
      workingHours: '24/7',
      contacts: '+996 770 12 21 12',
      images: [
        '/fixtures/jannat_1.jpq',
        '/fixtures/jannat_2.jpq',
        '/fixtures/jannat_3.jpq',
        '/fixtures/jannat_4.jpq',
      ],
    ...
    const location7 = await this.locationRepository.create({
      ...
      coordinates: { lat: '42.879600353285376', lon: '74.61218808163758' },
      description: 'Hotel',
      workingHours: '24/7',
